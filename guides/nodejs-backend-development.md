Node.js is a runtime environment that allows you to run JavaScript on our machine instead of just the browser. This allows us to use Javascript to build backend apis and write server side code.
